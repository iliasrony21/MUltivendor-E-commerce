				...
				<nav class="navbar navbar-expand">
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="{{(Auth::user()->pic != '')? asset('backend/assets/admin/'.Auth::user()->pic) : asset('backend/assets/admin/admin.png')}}" class="user-img" alt="user avatar">
						...
						<ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="{{route('admin.changepassword')}}"><i class='bx bx-home-circle'></i><span>change password</span></a>
							</li>

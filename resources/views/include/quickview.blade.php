                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                            <div class="detail-gallery">
                                ...
                                <div class="product-image-slider">
                                   @php
                                     $images = App\Http\Controllers\FrontendController::gallery($featuredproduct->id);
                                   @endphp
                            ...
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="clearfix product-price-cover">
                                    <div class="product-price primary-color float-left">
                                        <span class="current-price text-brand">{{ $featuredproduct->discount_price }}</span>
                                        <span>
                                            <span class="save-price font-md color3 ml-15">26% Off</span>
                                            <span class="old-price font-md ml-15">{{ $featuredproduct->selling_price }}</span>
                                        </span>
                                    </div>
                                </div>
                                <div class="detail-extralink mb-30">
                                    ...
                                    <div class="product-extra-link2">
                                        <button value="{{ $featuredproduct->id }}" type="submit" class="button button-add-to-cart qview_btn"><i class="fi-rs-shopping-cart"></i>Add to cart</button>
                                    </div>
                                </div>
                                <div class="font-xs">
                                    <ul>

                    ...
                    <div class="table-responsive shopping-summery">
                        <table class="table table-wishlist">
                            ...
                            <tbody>
                             ...
                             @php $sum = $sum + $cartItem->price;@endphp
                                ...
                                <tr class="pt-30">
                                    ...
                                    <td class="image product-thumbnail pt-40"><img src="{{ asset('uploads/product/'.$cartItem->image) }}" alt="#"></td>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="cart_total_amount">
                                            <h4 class="text-brand text-end">{{ $sum }}</h4>
                                        </td>
                                    </tr>
                                    <tr>
